window.KadenSite=(function(){
  ...
  function nav(active){var pages=[['index.html','商品コンサル','home'],['sales_mode.html','接客モード','sales'],['basics.html','基礎知識','basics'],['makers.html','メーカー比較','makers'],['memo.html','端末メモ','memo']];return '<header class="siteHeader"><div class="shell"><div class="headRow"><a class="brand" href="index.html">家電販売ナレッジ</a><div class="nav">'+pages.map(function(p){return'<a class="'+(active===p[2]?'active':'')+'" href="'+p[0]+'">'+p[1]+'</a>'}).join('')+'</div></div></div></header>'}
  function productTabs(product,active){var id=encodeURIComponent(product.id);return '<div class="tabs"><a class="tabLink '+(active==='consult'?'active':'')+'" href="product.html?product='+id+'">コンサル</a><a class="tabLink" href="sales_mode.html?product='+id+'">接客モード</a><a class="tabLink '+(active==='basics'?'active':'')+'" href="basics.html?product='+id+'">基礎知識</a><a class="tabLink '+(active==='makers'?'active':'')+'" href="makers.html?product='+id+'">メーカー比較</a></div>'}
